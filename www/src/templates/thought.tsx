...
const ThoughtTemplate: React.FC<PageProps<ThoughtTemplateProps>> = ({ data: { thought } }) => (
  <Layout thought>
    <SEO
      title={`${thought.title} | Dapp-Learning`}
    ...
    <Container>
      ...
      >
        ...
        <div sx={{ fontSize: 1, fontWeight: `medium` }}>
          You're reading a short post about Dapp-Learning. <br /> Go back to the homepage to view all content & give the
      ...
      >
        ...
        <TwitterShareButton
          url={`https://dapp-learning.com${thought.slug}`}
          via="Dapp_learning"
          title={thought.title}
          sx={{
